...
public:
   ...
   // MY OWN CODE - V M CAO : add two virtual method for retrive data from child class
...
// MY OWN CODE - V M Cao : setting type fied
protected:
	Symbol type;
// End of code
public:
...
public:
   ...
   // MY OWN CODE -  V M Cao : add new vitual method to get expression out;
   virtual Expression getExpression() = 0;
   virtual Symbol getType_decl() = 0;
   // End of code
#ifdef Case_EXTRAS
   Case_EXTRAS
#endif
...
public:
   ...
   // My OWN CODE - V.M. Cao : implement two methods to get data to test class graph inhenrence
	Symbol getParent(){
		return parent;
	}
	Symbol getName(){
...
protected:
   ...
   Expression expr;
public:
	// MY OWN CODE - V M Cao : define get Expression and get Type_decl method
