...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expressions> coma_expr_list
    %type <expressions> semi_expr_list
    %type <expressions> case_expr_list
    ...
    */
	...
	;
	case_expr_list :	OBJECTID ':' TYPEID DARROW expr ';'
	{
		@$ = @6;
		SET_NODELOC(@6);
		$$ = branch($1, $3, $5);
